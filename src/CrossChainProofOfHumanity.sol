...
contract CrossChainProofOfHumanity is ICrossChainProofOfHumanity {
    ...
    function receiveUpdate(
        ...
        console.log("received | owner", _owner);
        console.log("received | humanityId", uint160(_humanityId));
        console.log("received | expirationTime", _expirationTime);
    ...
    function isHuman(address _owner) external view returns (bool) {
        ...
        return (humanityId != 0 &&
                ...
                humanity.owner == _owner &&
                humanity.expirationTime > block.timestamp) || proofOfHumanity.isHuman(_owner);
    }
}
